...
const AboutHighlightCard = ({ icon: Icon, title, description }: AboutHighlightCardProps) => {
  return (
    <div className="group relative p-6 rounded-2xl bg-gradient-to-br from-card-dark to-card-dark/50 border border-foreground/10 hover:border-primary/30 transition-all duration-500 hover:translate-x-2">
